...
#' Runs over all time steps and calls \code{WALRUS_step_alt}
...
#' @export WALRUS_loop_alt
#' @examples
#' x=1
#' 
WALRUS_loop_alt = function(pars)
  {
...
# dG and hQ    
  ...
  {  
    ...
    {
      o_step[1,]   = WALRUS_step_alt(pars=pars, i=i, t1=start_step, t2=end_step)
...
WALRUS_loop_alt  = cmpfun(WALRUS_loop_alt)
